...
| `B-PAGE-CLS-004` | 教室编辑 | “维护中”状态保存 | 应能正常提交和回显               | 页面操作复验通过       | 通过 |
...
| `B-PAGE-SCH-002` | 排课编辑 | 冲突提示展示 | 冲突时页面应显示提示，不直接保存 | 页面操作复验通过             | 通过 |
...
| `B-PAGE-AUTO-002` | 自动排课页 | 任务主链路             | 发起任务、轮询、预览、应用应闭环 | 页面主链路复验通过               | 通过 |
