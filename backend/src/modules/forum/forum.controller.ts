...
export class ForumController {
  ...
  static async createPost(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '发布失败');
    }
  }
  ...
  static async getPosts(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '获取列表失败');
    }
  }
  ...
  static async getPostDetail(req: Request, res: Response) {
    try {
      const postId = ForumController.getParamId(req);
      const post = await ForumService.getPostDetail(postId, req.user!.userId);
      success(res, post);
    } catch (err) {
      ForumController.handleError(res, err, '获取详情失败');
    }
  }
  ...
  static async updatePost(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '更新失败');
    }
  }
  ...
  static async deletePost(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '删除失败');
    }
  }
  ...
  static async togglePinPost(req: Request, res: Response) {
    try {
      if (!ForumController.isAdminOrTeacher(req)) {
        throw new ForbiddenError('No permission to pin post');
      }
      ...
      ForumController.handleError(res, err, '置顶操作失败');
    }
  }
  ...
  static async createComment(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '评论失败');
    }
  }
  ...
  static async getComments(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '获取评论失败');
    }
  }
  ...
  static async hideComment(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '隐藏评论失败');
    }
  }
  ...
  static async restoreComment(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '恢复评论失败');
    }
  }
  ...
  static async getHiddenComments(req: Request, res: Response) {
    try {
      if (!ForumController.isAdminOrTeacher(req)) {
        throw new ForbiddenError('No permission to view hidden comments');
      }
      ...
      ForumController.handleError(res, err, '获取隐藏评论失败');
    }
  }
  ...
  static async createAnnouncement(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '公告发布失败');
    }
  }
  ...
  static async getAnnouncements(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '获取公告失败');
    }
  }
  ...
  static async updateAnnouncement(req: Request, res: Response) {
    try {
      const announcementId = ForumController.getParamId(req);
      ...
      ForumController.handleError(res, err, '公告更新失败');
    }
  }
  ...
  static async deleteAnnouncement(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '公告删除失败');
    }
  }
  ...
  static async searchPosts(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '搜索失败');
    }
  }
  ...
  static async getStats(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '获取统计数据失败');
    }
  }
  ...
  static async getHotPosts(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '获取热帖排行失败');
    }
  }
  ...
  static async getUserStats(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '获取用户统计失败');
    }
  }
  ...
  static async getCourseActivityStats(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, 'Failed to get course activity');
    }
  }
  ...
  static async exportStats(req: Request, res: Response) {
    try {
      ...
      ForumController.handleError(res, err, '导出统计失败');
    }
  }
  ...
  static async uploadAttachment(req: Request, res: Response) {
    try {
      ...
      if (!fileName || !content) {
        throw new ValidationError('File name and content are required');
      }
      ...
      const mimeType = mimeMap[ext] || fileType || 'application/octet-stream';
      ...
      ForumController.handleError(res, err, '附件上传失败');
    }
  }
  ...
  static async uploadAttachments(req: Request, res: Response) {
    try {
      ...
      if (files.length > 10) {
        throw new ValidationError('At most 10 files can be uploaded at once');
      }
      ...
      for (const file of files) {
        ...
        if (!fileName || !content) {
          throw new ValidationError('每个文件需要提供文件名和内容');
        }
      ...
      ForumController.handleError(res, err, '批量上传失败');
    }
  }
